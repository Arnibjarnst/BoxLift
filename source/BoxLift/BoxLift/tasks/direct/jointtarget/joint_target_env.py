...
class JointTargetEnv(DirectRLEnv):
    cfg: JointTargetEnvCfg

    def __init__(self, cfg: JointTargetEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def _setup_scene(self):
        ...
        self.cfg.episode_length_s = self.dt * (self.joints_l.shape[0] - 1)
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        self.reset_terminated = torch.zeros_like(time_out, dtype=torch.bool)

        return self.reset_terminated, time_out
    
    def _reset_robot(self, env_ids: Sequence[int] | None = None):
        if env_ids is None:
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        total_reward = rew_track - rew_regularization
